...
df_with_map <- df %>%
  group_by(cell) %>%
  mutate(pptMean = mean(pptTotal, na.rm = T),
         pptAnomalyAbs = pptMean - pptTotal) %>%
  ungroup()
...
write_rds(mod1, here("data", "processed", "models", "mod1_annual.rds"))
...
write_rds(mod2, here("data", "processed", "models", "mod2_annual.rds"))
