...
```{r load, results = "hide", include = FALSE}
...
jpeg("figures/paper_1_plots/cor_plot.jpg",
...
I also include a smooth function of latitude and longitude
...
anomalously high values (potentially irrigated agriculture, river regions etc.)
but they are a very small fraction of the dataset.

The spatial term still shows an extremely low range of values in the Western
...
# Plot main GAM partial effect plots
...
ggsave("figures/paper_1_plots/main_gam_plot.jpg", plot = gam_plot,
...
ggsave("figures/paper_1_plots/mod1_diag_plot.jpg", plot = mod1_diag,
       width = 20, height = 16, units = "cm", dpi = 300)

mod2_k8_diag <- appraise(mod2_k8, n_bins = 60, point_alpha = 0.05, line_col = "#117733")
ggsave("figures/paper_1_plots/mod2_k8_diag_plot.jpg", plot = mod2_k8_diag,
       width = 20, height = 16, units = "cm", dpi = 300)
mod2_k12_diag <- appraise(mod2_k8, n_bins = 60, point_alpha = 0.05, line_col = "#117733")
ggsave("figures/paper_1_plots/mod2_k12_diag_plot.jpg", plot = mod2_k12_diag,
       width = 20, height = 16, units = "cm", dpi = 300)
mod2_k16_diag <- appraise(mod2_k8, n_bins = 60, point_alpha = 0.05, line_col = "#117733")
ggsave("figures/paper_1_plots/mod2_k16_diag_plot.jpg", plot = mod2_k16_diag,
       width = 20, height = 16, units = "cm", dpi = 300)
...
tmap_save(resid_plot, "figures/paper_1_plots/mod2_resid_map.jpg",
